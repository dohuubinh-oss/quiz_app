        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <Card className="mb-8 shadow-2xl border-0 rounded-3xl overflow-hidden bg-white">
            <div className="text-center py-12">
              ...
              <Title level={1} className={`mb-4 ${resultMessage.color}`}>
                {resultMessage.title}
              </Title>
              ...
              <Button
                ...
                onClick={resetQuiz}
                size="large"
                className="h-12 px-8 bg-gradient-to-r from-blue-500 to-purple-600 border-0 rounded-xl font-medium shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
              >
                🔄 Try Again
              </Button>
            </div>
                  ...
                  >
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-grow">
                        ...
                        <Paragraph className="text-gray-700 mb-4 text-lg">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <Card className="shadow-2xl border-0 rounded-3xl overflow-hidden bg-white animate-fade-in-up">
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 p-8 text-white">
            <h1 className="text-white mb-4 leading-tight animate-slide-in">
            ...
            <div className="flex items-center space-x-4 opacity-90">
              <span className="px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-sm font-medium">
                ...
                {currentQuestion.question_type === "four_choices" &&
                  "📝 Multiple Choice"}
                {currentQuestion.question_type === "input" && "✍️ Text Answer"}
              </span>
              <span className="px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-sm font-medium">
                    ...
                    ([key, value], index) => (
                      ...
                      >
                        <Radio value={key} className="w-full p-0 m-0">
                          <div
                            className={`
                          w-full p-6 border-2 rounded-2xl transition-all duration-300 cursor-pointer transform hover:scale-[1.02]
                          ${
                        ...
                        `}
                          >
                            ...
                            `}
                              ...
                              <span className="text-lg text-gray-800 flex-1 font-medium">
                                {value}
                              </span>
                              {readOnly &&
                                key === currentQuestion.correct_answer && (
                                  <CheckCircleOutlined className="text-green-500 text-2xl animate-bounce" />
                                )}
                            </div>
                          </div>
                        </Radio>
            ...
            {currentQuestion.question_type === "input" && (
              <div className="space-y-4 animate-fade-in">
                <Input
                  ...
                  onChange={(e) => handleAnswer(e.target.value)}
                  disabled={readOnly}
                  className="h-16 text-lg border-2 border-gray-200 rounded-2xl hover:border-blue-400 focus:border-blue-500 transition-all duration-300 shadow-sm focus:shadow-lg"
                  size="large"
                />
                {readOnly && (
          ...
          <div className="px-8 pb-8">
            <div className="flex justify-between items-center">
              <Button
                ...
                size="large"
                className="h-14 px-8 border-2 border-gray-300 hover:border-gray-400 transition-all duration-300 rounded-xl font-medium disabled:opacity-50"
              >
              ...
              <Button
                ...
                size="large"
                className="h-14 px-8 bg-gradient-to-r from-blue-500 to-purple-600 border-0 hover:shadow-xl hover:scale-105 transition-all duration-300 rounded-xl font-medium"
              >
                <span className="flex items-center space-x-2">
